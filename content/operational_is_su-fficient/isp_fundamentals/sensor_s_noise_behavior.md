...
| Sensor problem | Madarin |  |
| --- | --- | --- |
| Quantum efficiency (QE) | 量子效率 | 光子打到感光元件上而產生電子，這就是光電效應；光產電的效率即是量子效率。偏折角度大的藍紫光會好好進到感應區，偏折角度小的會戳進另一格，變得紅光就是容易色散，因此力道小；另外是，波長越長頻率越低能量越低，所以紅光比起綠藍光QE效率較低，SNR也比較差 |
|  |  |  |

| Sensor Noise type | Madarin |  |
| --- | --- | --- |
