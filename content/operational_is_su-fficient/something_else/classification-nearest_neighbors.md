...
![image.png](/operational_is_su-fficient/something_else//operational_is_su-fficient/something_else/classification-nearest_neighbors/image.png)

這是訓練圖集的k =1分類，可以看出中心黃色區域只要在範圍內就是黃色分類，稍微偏一點就是綠色

![image.png](/operational_is_su-fficient/something_else//operational_is_su-fficient/something_else/classification-nearest_neighbors/image_1.png)
