...
1. 設計多個ground truth，目標在訓練圖片集中的比例最好有落差，辨識並不在乎位置。
2. 每張圖的ground truth框的大小對應到三種降取樣尺寸下、每個降取樣各預設 anchor box，一張圖共有9個預設格。

3. 整資料集透過k-means 產生 具代表性的九格(3個圖片尺寸大小、一個尺寸3個框)，為此資料集的代表框
...
![image.png](/operational_is_su-fficient/something_else//operational_is_su-fficient/something_else/classic_model_-_yolov3/image.png)

[Yolov3 C-Model 解析 - 讀取與建立](/operational_is_su-fficient/something_else//operational_is_su-fficient/something_else/classic_model_-_yolov3/yolov3_c-model_%e8%a7%a3%e6%9e%90_-_%e8%ae%80%e5%8f%96%e8%88%87%e5%bb%ba%e7%ab%8b.md)

[Yolov3 C-Model 解析 - 偵測](/operational_is_su-fficient/something_else//operational_is_su-fficient/something_else/classic_model_-_yolov3/yolov3_c-model_%e8%a7%a3%e6%9e%90_-_%e5%81%b5%e6%b8%ac.md)